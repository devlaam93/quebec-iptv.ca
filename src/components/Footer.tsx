          ...
          <div className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="bg-background/50 sm:bg-transparent rounded-2xl sm:rounded-none p-6 sm:p-0 border border-border/50 sm:border-0">
                ...
                <a href="/" className="group flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-3 mb-4">
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-orange-400 via-orange-500 to-red-600 rounded-[50%] p-2 sm:p-2 shadow-xl shadow-orange-500/30 group-hover:shadow-2xl group-hover:shadow-orange-500/50 transition-all duration-500">
                      <div className="bg-gradient-to-br from-background to-background/95 rounded-[50%] p-1.5 sm:p-1.5 backdrop-blur-sm">
                        <img src={animatedLogo} alt="IPTV Quebec Premium" className="w-8 h-8 sm:w-6 sm:h-6 object-contain group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 drop-shadow-lg" />
                      </div>
                    </div>
                  </div>
        ...
        <div className="border-t border-border py-6">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              ...
              <VisaIcon className="h-8 w-8 opacity-80 hover:opacity-100 transition-opacity" />
              <MastercardIcon className="h-8 w-8 opacity-80 hover:opacity-100 transition-opacity" />
              
              <PaypalIcon className="h-8 w-8 opacity-80 hover:opacity-100 transition-opacity" />
              
              
              <InteracIcon className="h-8 w-8 opacity-80 hover:opacity-100 transition-opacity" />
            </div>
